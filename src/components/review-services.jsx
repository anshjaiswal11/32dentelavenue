    ...
    <section className="py-16 md:py-20 bg-[#f7f4f1] overflow-hidden w-full">
      <div className="w-full">
        <div className="max-w-3xl mx-auto text-center mb-12 px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-[#87d4cb] mb-6 font-roboto-slab">
            Real Stories, Real Results
          </h1>
          <p className="text-lg text-[#424040]/70 font-raleway">
            Discover how our patients experienced life-changing dental transformations. Their stories showcase our commitment to excellence and personalized care..
          </p>
        </div>
