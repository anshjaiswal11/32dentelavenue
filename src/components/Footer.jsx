...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#424040] text-white/90">
      {/* Main Footer Content */}
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-[#424040] text-2xl font-bold">32</span>
              </div>
              <div className="text-white font-semibold">
                <div>Dental Avenue</div>
                <div className="text-xs text-white/60">Advanced Dental Care</div>
              </div>
            </div>
            <p className="text-sm text-white/70 leading-relaxed">
              At 32 Dental Avenue, we combine advanced technology with compassionate care 
              to deliver exceptional dental treatments. Your smile is our priority.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors">
              ...
              <a href="https://twitter.com" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-sm text-white/70">{footerLinks.contact.phone}</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#88d4cb]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-sm text-white/70">{footerLinks.contact.email}</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#88d4cb]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm text-white/70">{footerLinks.contact.hours}</p>
              </div>
            </div>
          </div>
        </div>
