  ...
  return (
    <section className="flex flex-col md:flex-row w-full min-h-screen bg-[#f7f4f1] overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-12">
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-6 font-[roboto-slab]">
        ...
        <button className="w-fit bg-[#88d4cb] text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:bg-[#6bc2b9] transition duration-300 font-[raleway]">
