...
const TeethAlignment = () => {
    ...
    return (
        <div className="bg-neutral-bg min-h-screen pt-16 md:pt-20">
            <Helmet>
                <title>Affordable Teeth Alignment in Rohini | 32 Dental Avenue</title>
                <meta name="description" content="Get precise teeth alignment in Rohini at 32 Dental Avenue with braces & clear aligners. Achieve a perfect, confident smile. Book your consultation today!" />
                <link rel="canonical" href="https://www.32dentalavenue.in/teeth-alignment" />
            </Helmet>
            {/* Hero Section */}
