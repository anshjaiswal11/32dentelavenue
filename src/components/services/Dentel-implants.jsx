...
const DentalImplants = () => {
    ...
    return (
        <div className="bg-neutral-bg min-h-screen pt-16 md:pt-20">
            <Helmet>
                <title>Top Dental Implant Treatment in Rohini | 32 Dental Avenue</title>
                <meta name="description" content="32 Dental Avenue offers top-quality dental implants in Rohini with modern techniques and experienced dentists. Restore your smile with confidence." />
                <link rel="canonical" href="https://www.32dentalavenue.in/dental-implants" />
            </Helmet>
            {/* Hero Section */}
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-3xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-text-light mb-8 font-raleway">Everything You Need to Know About Dental Implants</p>
                    </div>
