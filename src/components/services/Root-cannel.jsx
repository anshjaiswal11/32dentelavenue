...
const RootCanal = () => {
    ...
    return (
        <div className="bg-neutral-bg min-h-screen pt-16 md:pt-20">
            <Helmet>
                <title>Pain-Free Root Canal Treatment in Rohini | 32 Dental Avenue</title>
                <meta name="description" content="Looking for root canal treatment in Rohini? Our experienced dentists at 32 Dental Avenue deliver precise, effective care to save your natural tooth." />
                <link rel="canonical" href="https://www.32dentalavenue.in/root-canal-treatment" />
            </Helmet>
            {/* Hero Section */}
